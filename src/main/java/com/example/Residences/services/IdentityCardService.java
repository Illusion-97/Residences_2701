...
@Service
public class IdentityCardService extends Generic_ServiceImpl<IdentityCard,String, IdentityCard, IdentityCardRepository> implements Generic_Service<IdentityCard,String> {
